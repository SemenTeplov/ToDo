...
<?php echo '<a href="pages/auth/edit.php?id='.$user['id'].'"><input type="button" value="Редактировать"></a>' ?>
<?php echo '<a href="pages/auth/remove.php?id='.$user['id'].'"><input type="button" value="Удалить"></a>' ?>
<form method="post" action='pages/auth/login.php'> <!-- change -->
